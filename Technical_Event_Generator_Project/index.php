<?php 
    ...
    while($data = mysqli_fetch_assoc($fetchingEvents))
    {
        ...
        if($status == "Active")
        {
            ...
            {
                // Update! 
                mysqli_query($db, "UPDATE tech_event SET status = 'Expired' WHERE id = '". $event_id ."'") OR die(mysqli_error($db));
            }
        }else if($status == "InActive")
        {
            ...
            {
                // Update! 
                mysqli_query($db, "UPDATE tech_event SET status = 'Active' WHERE id = '". $event_id ."'") OR die(mysqli_error($db));
            }
        }
...
<html>
<head>
	<title>Login - Technical Event Generator System</title>
			...
			<div class="user_card">
				<div class="d-flex justify-content-center">
					<div class="brand_logo_container">
						<img src="assets/images/eventlogo.gif" class="brand_logo" alt="Logo">
					</div>
				</div>
...
<?php 
    ...
    }else if(isset($_POST['loginBtn']))
    {
        ...
        if(mysqli_num_rows($fetchingData) > 0)
        {
            ...
            ?>
                    <script> location.assign("events/index.php"); </script>
            <?php
                }
